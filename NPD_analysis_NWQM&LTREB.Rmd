...
temp_data_plot = temp %>%
  group_by(year) %>%
  mutate(effE_nit_r1_byYear = mean(effE_nit_r1,na.rm = T),
         effE_nit_r2_byYear = mean(effE_nit_r2,na.rm = T) )
...
ggplot(temp_data_plot, aes(x=effE_nit_r1, y=effE_nit_r2_byYear,colour=year)) + 
  geom_point(size=3) +
